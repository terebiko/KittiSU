...
// Adapted from ReSukiSU SettingsChooseWidget for KittiSU SettingsBaseWidget
// (BoxScope foreContent; no fillMaxWidth / isOnBackground / Koin theme config).
